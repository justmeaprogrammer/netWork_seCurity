...
from networksecurity.constant.trainig_pipeline import TARGET_COLUMN
from networksecurity.constant.trainig_pipeline import DATA_TRANSFORMATION_IMPUTER_PARAMS
...
class DataTransformation:
    ...
    def get_data_transformer_object(cls)->Pipeline:
        logging.info("entered get_data_transformer_object in Data Transformation class")
        try:
            imputer:KNNImputer = KNNImputer(**DATA_TRANSFORMATION_IMPUTER_PARAMS)
            logging.info(f"Initialised KNNImpyetr with following parameters:{DATA_TRANSFORMATION_IMPUTER_PARAMS}")
