...
class DataIngestion:
    ...
    def export_collection_as_dataframe(self):
        """
        Just to read the data from mongoDB
        """
    ...
    def split_data_as_train_test_split(self,dataframe:pd.DataFrame):
        try:
            ...
            logging.info("Train test Split done on dataFrame")
            
            logging.info("Exitted the split_data_as_train_test_split method ")
            
            dir_path=os.path.dirname(self.data_ingestion_config.training_file_path)
            os.makedirs(dir_path,exist_ok=True)
            
            logging.info("Exporting Train test split to filepaths")
