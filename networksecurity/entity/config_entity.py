...
class DataValidationConfig:
    def __init__(self,trainig_pipeline_config:TrainingPipelineConfig):
        self.data_validation_dir=os.path.join(trainig_pipeline_config.artifact_dir,
                                              trainig_pipeline.DATA_VALIDATION_DIR_NAME)
        
        self.valid_data_dir=os.path.join(self.data_validation_dir,
                                         trainig_pipeline.DATA_VALIDATION_VALID_DIR)
        self.invalid_data_dir=os.path.join(self.data_validation_dir,
                                           trainig_pipeline.DATA_VALIDATION_INVALID_DIR)
        ...
        self.drift_report_file_path=os.path.join(self.data_validation_dir,
                                                 trainig_pipeline.DATA_VALIDATION_DRIFT_REPORT_DIR,
                                                 trainig_pipeline.DATA_VALIDATION_DRIFT_REPORT_FILE_NAME)


class DataTransformationConfig:
    def __init__(self,training_pipeline_config:TrainingPipelineConfig):
        self.data_transformation_dir:str = os.path.join(training_pipeline_config.artifact_dir,
                                                        trainig_pipeline.DATA_TRANSFORMATION_DIR_NAME)
